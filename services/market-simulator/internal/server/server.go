...
// Server represents the HTTP server for market simulator
type Server struct {
...
func (s *Server) setupRouter() {
	...
	{
		// Simulator endpoints
		api.GET("/status", s.simulatorHandler.GetStatus)
		api.POST("/volatility", s.simulatorHandler.InjectVolatility)

		// Market data endpoints
		api.GET("/market/:symbol", s.simulatorHandler.GetMarketData)
		api.GET("/price/:symbol", s.simulatorHandler.GetCurrentPrice)
		api.GET("/history/:symbol", s.simulatorHandler.GetPriceHistory)
		api.GET("/symbols", s.simulatorHandler.GetAllSymbols)
	}
